...
unsigned int nStakeTargetSpacing = 80;			// 80 sec block spacing

int64 nChainStartTime = 1406044997;
...
const string strMessageMagic = "PayzorCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 80 * 10;  // 10 blocks
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in PayzorCoin
    bool fStrictPayToScriptHash = true; // Always active in PayzorCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "PayzorCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "P A Y Z O R";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = 1406044999;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 6015632;
        ...
        assert(block.hashMerkleRoot == uint256("0x772d99abdc05da590bde91a80813c4038e8c1e4568ff9495506f1e6452974725"));
